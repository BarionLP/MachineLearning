...
public sealed class NadamLayerOptimizer : ILayerOptimizer
{
    ...
    public void Apply(int dataCounter)
    {
        ...
        Layer.Biases.SubtractInPlace((FirstMomentBiases, SecondMomentBiases, GradientCostBiases).Map(WeightReduction));
        ...
        Layer.Weights.SubtractInPlace((FirstMomentWeights, SecondMomentWeights, GradientCostWeights).Map(WeightReduction));
