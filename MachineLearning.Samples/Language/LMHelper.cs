...
//        } while (true);
//    }
//    public static void StartChat(EmbeddedModel<int[], char> model, int contextSize, CharTokenizer tokenizer)
//    {
//        string input;
//        do
//        {
...
//    public static void Generate(int[] input, EmbeddedModel<int[], char> model, int contextSize, CharTokenizer tokenizer)
//    {
//        Console.Write(input);
//        char prediction;
//        Weight confidence;
