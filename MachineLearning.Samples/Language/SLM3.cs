...
public sealed class SLM3
{
    ...
    public static StringTokenizer Tokenizer { get; } = new(WORD_TOKENS, SYMBOLS, [("“", "\""), ("”", "\""), ("–", "-"), ("—", "-"), ("’", "'"), ("it’s", "it's"), ("don’t", "don't"), ("can’t", "can't")]);
    ...
    public static EmbeddedModel<int[], int> TrainDefault(EmbeddedModel<int[], int>? model = null, TrainingConfig? config = null, ITrainingSet? trainingSet = null, Random? random = null)
    {
        ...
        var trainer = ModelTrainer.Create(model, config ?? DefaultTrainingConfig(), trainingSet ?? GetTrainingSet());
